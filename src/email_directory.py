...
class EmailDirectory:
    def __init__(self):
        self.engineers_email_file = "M:\\_R&D List Docs\\DependencyFiles\\EngineerEmails_test.txt"
        self.all_email_file = "M:\\_R&D List Docs\\DependencyFiles\\AllEmails_test.txt"
